...
<html>
<head>
    <title>${ui.message("login.title")}</title>
    <link rel="shortcut icon" type="image/ico" href="/${ui.contextPath()}/images/FDAH_LOGO_ICON.ico"/>
    <link rel="icon" type="image/png\" href="/${ui.contextPath()}/images/FDAH_LOGO_ICON.png"/>
    ${ui.resourceLinks()}
...
<script type="text/javascript">
 ...
 pageReady = true;
        ...
        document.getElementById("fdah").src = str;
...
<header>
    <div class="logo">
        <a href="${ui.pageLink("referenceapplication", "home")}">
            <img src="${ui.resourceLink("fdah", "/images/FDAH_LOGO_LARGE.png")}"/>
        </a>
    </div>
</header>
